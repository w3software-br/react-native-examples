    ...
    <Tab.Navigator
      ...
      <Tab.Screen 
        ...
        options={{
          ...
          tabBarIcon: ({ color, size }) => {
            return  (<Icon name={Platform.OS === 'ios' ? "ios-home" : "md-home" } 
            color={color} 
            size={size} />)
          },
        }} />
      ...
      <Tab.Screen 
        ...
        options={{
          tabBarLabel: "Contact",
          tabBarIcon: ({ color, size }) => {
            return  (<Icon name={Platform.OS === 'ios' ? "ios-contacts" : "md-contacts" } 
            color={color} 
            size={size} />)
          },
        }} />
      ...
      <Tab.Screen 
        ...
        options={{
          tabBarLabel: "About",
          tabBarIcon: ({ color, size }) => {
            return  (<Icon name={Platform.OS === 'ios' ? "ios-information-circle" : "md-information-circle" } 
            color={color} 
            size={size} />)
          },
        }} />
